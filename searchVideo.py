    ...
    if req.status == 200 or req.status == 0:
        ...
        for video in data.get("items", []):
            ...
            vRAWs.append(f"<li class='video'><a href='?vid={vID}'>"
                         f"<div class='img'><img src='{vIMG}' height='240px' width='420px'>"
...
`8888Y' YP   YP  `Y88P'   `8b8' `8d8'       ~Y8888P'
    ...
    doc["list"].html = str(
        ...
        f"<div class='Csearch'>"
        f"<form id='Cgrid-form-container' class='Cgrid-form-container' autocomplete='off'>"
        f"    <div class='center grid-vorc'>"
        f"    </div>"
        f"    <div class='center grid-search'>"
        f"        <div class='material-textfield'>"
        f"            <input type='text' name='q'>"
        f"            <label data-content='NOT WORKING!!! WIP!!!'></label>"
        f"        </div>"
        f"    </div>"
        f"    <div class='center grid-option'>"
        f"        <div class='center radio-buttons'>"
        f"            <input type='radio' id='Crelevance' class='first' name='order' value='relevance' checked>"
        f"            <label for='Crelevance' class='first'>Relevance</label>"
        f"            <input type='radio' id='Crating' class='second' name='order' value='rating'>"
        f"            <label for='Crating' class='second'>Rating</label>"
        f"            <input type='radio' id='Ctitle' class='third' name='order' value='title'>"
        f"            <label for='Ctitle' class='third'>Name</label>"
        f"            <input type='radio' id='CviewCount' class='forth' name='order' value='viewCount'>"
        f"            <label for='CviewCount' class='forth'>Views</label>"
        f"            <input type='radio' id='Cdate' class='fith' name='order' value='date'>"
        f"            <label for='Cdate' class='fith'>Time</label>"
        f"            <div class='slider'></div>"
        f"        </div>"
        f"    </div>"
        f"    <input type='hidden' name='page' value=' '>"
        f"    <input type='hidden' name='pageNum' value='1'>"
        f"</form><br>"
        f"</div>"
